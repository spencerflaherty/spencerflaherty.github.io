...
Designed a content writer portfolio with custom animations and formatting to showcase writing samples — a clean link for her resume.
...
**LEFT:** A pen or pencil — simple diagonal line (the pen shaft) with a small triangular tip at the bottom representing writing/content creation.

**CENTER:** Multiple document pages — 3 small rectangles slightly offset/stacked representing a portfolio of writing samples.

**RIGHT:** A resume/CV document — single rectangle with horizontal lines at the top (header/name) and 2-3 bullet points below (small circles with short lines) representing resume format.

**CRITICAL:** All three stages must feel equally weighted. This shows: writing → portfolio → professional resume link.
