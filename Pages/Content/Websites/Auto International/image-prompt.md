...
Built an SEO-focused Squarespace site for an auto shop with no prior web presence — now ranking in local Google search.
...
**LEFT:** A car — simple side view using basic rectangles: rectangular body with two circles below for wheels. Keep it iconic and minimal.

**CENTER:** A browser window — rectangle with three small circles in the top-left corner representing window controls. Inside the browser, show 2-3 horizontal lines suggesting web content.

**RIGHT:** A map pin — classic teardrop/inverted drop shape with a circle cutout inside, representing local search visibility and Google Maps ranking.

**CRITICAL:** All three stages must feel equally weighted. This shows: auto shop → website → local search ranking.
