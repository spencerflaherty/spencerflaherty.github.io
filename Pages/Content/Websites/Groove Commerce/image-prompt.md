...
Led the redesign of my employer's site — handling design, copy, structure, and functionality — tripling organic traffic.
...
**LEFT:** A before/after split — two browser windows side by side, left one with messy/chaotic lines inside, right one with clean organized lines, representing the redesign transformation.

**CENTER:** A toolbox or wrench — simple wrench shape (handle and adjustable head) or toolkit rectangle with 2-3 tool shapes inside, representing the comprehensive redesign work (design, copy, structure, functionality).

**RIGHT:** An upward trending arrow — simple arrow pointing up and to the right at 45-degree angle with "3x" suggested by three short horizontal lines near it, representing traffic tripling.

**CRITICAL:** All three stages must feel equally weighted. This shows: redesign → comprehensive work → 3x traffic growth.
