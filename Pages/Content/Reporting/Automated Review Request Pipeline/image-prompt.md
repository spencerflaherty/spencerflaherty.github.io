...
Pulls recent customers from CRM, filters out existing reviewers, and sends AI-varied email requests for Google reviews. Increased both review volume and average rating.

**The Stack:**
- Data Source: SimPro (CRM) + Power BI
- Email: iContact
- AI Layer: Claude (RAG personalization)

## IMAGE DESCRIPTION:

4 icon groups arranged left to right, all the same vertical height. Tiny white chevrons between them as connectors.

**LEFT:** A database/cylinder shape representing the CRM — stack of 2-3 horizontal cylinders suggesting data storage.

**CENTER-LEFT:** A filter funnel — wide trapezoid at top narrowing to small rectangle at bottom, representing filtering out existing reviewers.

**CENTER-RIGHT:** An envelope with 2-3 horizontal lines inside suggesting personalized email content being generated.

**RIGHT:** A star — simple 5-pointed star shape representing Google review/rating output.

**CRITICAL:** All four stages must feel equally weighted and prominent. This shows: CRM data → filtering → personalized outreach → reviews.
