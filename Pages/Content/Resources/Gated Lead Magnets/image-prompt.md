...
Wrote and published lead-gen eBooks to capturing intent signals for instant sales routing while building organic search authority. Made PDFs crawlable, now cited in ChatGPT and Gemini responses.

**The Stack:**
- Writing: Google Docs
- Design: Adobe InDesign
- Distribution: Organic + Paid (Crawlable PDFs)

## IMAGE DESCRIPTION:

4 icon groups arranged left to right, all the same vertical height. Tiny white chevrons between them as connectors.

**LEFT:** An eBook/document — rectangle with top-right corner folded down and 3-4 horizontal lines inside representing written content.

**CENTER-LEFT:** A lock and form — small padlock shape (circle top, rectangle bottom) next to a simple form (rectangle with 2 horizontal lines) representing the gate/capture mechanism.

**CENTER-RIGHT:** A person silhouette (circle head, trapezoid body) representing the lead being captured.

**RIGHT:** A robot/AI head — simple rectangular head with two square eyes, representing AI systems (ChatGPT, Gemini) citing the content.

**CRITICAL:** All four stages must feel equally weighted. This shows: content creation → gated access → lead capture → AI citation/authority.
