...
Identified repetitive tasks and built small agentic workflows to handle them such as proposals, ROI calculators, incentive lookups. This frees the team to focus on creative, high-value work.
...
**LEFT:** A repetitive task icon — 3 identical small squares stacked vertically representing repetitive/manual work being done over and over.

**CENTER:** A robot/agent — simple blocky robot shape with rectangular head, rectangular body, and two rectangular arms. Keep it iconic and geometric, not detailed. This represents AI agents taking over the tasks.

**RIGHT:** A person silhouette (circle head, trapezoid body) with an upward arrow next to them suggesting freed capacity and focus on higher-value work.

**CRITICAL:** All three stages must feel equally weighted. This shows: repetitive tasks → AI automation → freed human capacity.
